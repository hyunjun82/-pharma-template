...
const categories = [
  {
    ...
    icon: '🏠',
    calculators: [
      { name: '취득세 계산기', url: '/realestate/acquisition-tax', popular: true },
      ...
      { name: '평수 계산기', url: '/realestate/pyeong-converter' },
    ],
  },
  {
    id: 'salary',
    ...
    icon: '💰',
    calculators: [
      { name: '연봉 실수령액 계산기', url: '/salary/take-home-pay', popular: true },
  ...
  },
  {
    ...
    icon: '🏦',
    calculators: [
      { name: '대출이자 계산기', url: '/loan/interest', popular: true },
  ...
  },
  {
    ...
    icon: '💊',
    calculators: [
      { name: 'BMI 계산기', url: '/health/bmi', popular: true },
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">가이드</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">API</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">문의</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-gray-900 mb-4">정보</h4>
              <ul className="space-y-2">
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">개인정보처리방침</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">이용약관</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-500 text-center">
              © 2025 JJYU Calculator. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
